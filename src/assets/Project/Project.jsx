function Project({projectName, description, divClass, changeLan, src, githubLink, pagesLink}) {
  return (
    <div id="project" className={`bg-[#483D8F] border h-150 w-full p-5 rounded-xl col-span-2 
    transition-all hover:drop-shadow-[0_0_10px_white] ${divClass}`}>
        ...
        <div className="flex flex-cols justify-center gap-30"> 
          <a href={githubLink} target="_blank" rel="noopener noreferrer">
            <p className="border w-40 h-10 flex items-center justify-center rounded-xl bg-blue-900
